...
const int n = 50;
string ground1[n],ground2[n],ground3[n],ground4[n],ground5[n],ground6[n]={""}; 
...
void setGround(string a,string b,string c,string d,string e,string f){
    ground1[0] = a; 
    ground2[0] = b; 
    ground3[0] = c; 
    ground4[0] = d; 
        ...
        if (sudah == true){
            ...
            if (GetAsyncKeyState(VK_UP) & 0x8000) {
                ...
                for (i=1; i<=3; i++){
                    ...
                    p1.posY -= 1;
                    //Cek koin
                    if((ground3[p1.posX] == "*" || ground3[p1.posX-1] == "*") && p1.posY == 9){skor++; ground3[p1.posX] = " ";}
                    if((ground4[p1.posX] == "*" || ground3[p1.posX-1] == "*") && p1.posY == 8){skor++; ground4[p1.posX] = " ";}
                    if((ground5[p1.posX] == "*" || ground3[p1.posX-1] == "*") && p1.posY == 7){skor++; ground5[p1.posX] = " ";}
                    if((ground6[p1.posX] == "*" || ground3[p1.posX-1] == "*") && p1.posY == 6){skor++; ground5[p1.posX] = " ";}
                    pindahPosisi();
                    Sleep(115);
                }
...
main(){
    ...
    int i = 0,r,musuh=0,nEnemy=0,groundLvl=2,koin = 0;
    bool isCoin = false;
    string newObstacle;
    char c;
	...
	while (!isDead)
    {
        ...
        if(r > 50 ){ // kalau angka random 50 - 100 maka muncul dinding
            switch (groundLvl)
                {
                case 2:
                    if(isCoin){setGround("#","#"," ","*"," "," "); isCoin = false;} 
                    else setGround("#","#"," "," "," ", " ");
                    break;
                case 3:
                    if(isCoin || nWall == 4 || nWall == 10 ){setGround("#","#","#"," ","*"," "); isCoin = false;} 
                    else setGround("#","#","#"," "," "," ");
                    break;
                case 4:
                    if(isCoin || nWall == 5 || nWall == 11){setGround("#","#","#","#"," ","*"); isCoin = false;} 
                    else setGround("#","#","#","#"," "," ");
                    break;
                case 5:
                    setGround("#","#","#","#","#"," ");
